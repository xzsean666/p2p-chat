...
use crate::commands::{
    ...
    load_local_account_secret_summary, load_pending_auth_runtime_client_uri,
    load_transport_snapshot, logout_chat_session, merge_remote_delivery_receipts,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            load_local_account_secret_summary,
