...
use crate::commands::{
    ...
    await_pending_auth_runtime_client_pairing, bootstrap_auth_session, bootstrap_status,
    cache_chat_message_media, cleanup_chat_media_assets, complete_login, create_group_conversation,
    load_auth_runtime_client_uri, load_chat_domain_overview, load_chat_session_message_updates,
    load_chat_session_messages, load_chat_sessions_overview, load_chat_shell_snapshot,
    load_pending_auth_runtime_client_uri, load_transport_snapshot, logout_chat_session,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            logout_chat_session,
            update_auth_runtime,
            load_auth_runtime_client_uri,
            load_pending_auth_runtime_client_uri,
            await_pending_auth_runtime_client_pairing,
